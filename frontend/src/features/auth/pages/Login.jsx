        ...
        <div className="bg-[#121318]/90 backdrop-blur-2xl rounded-3xl border border-amber-500/15 shadow-[0_0_60px_-15px_rgba(245,158,11,0.15)] p-8 sm:p-12 transition-all duration-300">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-sm text-zinc-400 font-normal max-w-sm mx-auto leading-relaxed">
              Sign in to access your curated marketplace, account settings, and orders.
            </p>
          </div>
          ...
          {successMessage && (
            <div className="mb-8 p-4 rounded-2xl bg-amber-500/10 border border-amber-500/30 text-amber-300 text-sm flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-amber-400/80 mt-1">Taking you to your destination...</p>
              </div>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-6" noValidate>
            ...
            <div className="group">
              <div className="flex items-center justify-between mb-2">
                <label
                  htmlFor="password"
                  className="block text-xs font-medium uppercase tracking-wider text-zinc-400 group-focus-within:text-amber-400 transition-colors"
                >
                  Password
                </label>
                <a
            ...
            >
              <div
                className={`w-5 h-5 rounded-lg flex items-center justify-center border transition-all duration-300 ${
                  formData.rememberMe
                    ...
                    : "bg-[#171922] border-zinc-700 group-hover:border-zinc-500"
                }`}
              >
                {formData.rememberMe && (
              ...
              <span className={`text-xs sm:text-sm font-medium transition-colors ${
                formData.rememberMe ? "text-amber-300" : "text-zinc-400 group-hover:text-zinc-300"
              }`}>
